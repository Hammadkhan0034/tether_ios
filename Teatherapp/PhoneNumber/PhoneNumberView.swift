                    ...
                    HStack {
                        Button {
                            ...
                            Text("\(countryFlag) \(countryCode)")
                                .padding(10)
                                .frame(minWidth: 80,minHeight: 50, maxHeight: 50)
                                
                                .foregroundColor(foregroundColor)                .overlay(RoundedRectangle(cornerRadius: 8).stroke(Color.gray, lineWidth: 1))
                        ...
                        TextField("", text: $mobPhoneNumber )
                            ...
                            .padding(10)
                            .frame(minWidth: 80,minHeight: 50, maxHeight: 50)                .overlay(RoundedRectangle(cornerRadius: 8).stroke(Color.gray, lineWidth: 1))
